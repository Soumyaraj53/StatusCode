...
const menuItems = [
 ...
 function Header() {
  ...
  return (
    <div className="relative w-full bg-white bg-opacity-10 backdrop-filter backdrop-blur-lg z-20" id="nav">
      <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-2 sm:px-6 lg:px-8">
          ...
          <ul className="ml-12 inline-flex space-x-8">
            {menuItems.map((item) => (
              <li key={item.name}>
                <a
                  href={item.href}
                  className="inline-flex items-center text-lg font-bold text-white hover:text-gray-900"
                >
                  {item.name}
                  <span>
        ...
        <div className="hidden space-x-2 lg:block">
          ...
          <button
            type="button"
            className="rounded-md border border-white px-3 py-2 text-sm font-semibold text-white shadow-lg focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-black"
          >
            Log In
          </button>
        </div>
